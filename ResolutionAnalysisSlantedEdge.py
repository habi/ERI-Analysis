...
Image1Name = os.path.join(StartPath, 'ERI-Grid4-15s-Exposure', 'ERI_060kV_029uA_15sExp_01.raw')
Image2Name = os.path.join(StartPath, 'Hamamatsu-Grid4-15s-Exposure', 'Hamamatsu_060kV_030uA_15sExp_01.raw')

Image1 = read_raw(Image1Name)
Image2 = read_raw(Image2Name)

Crop1 = Image1[100:900,1600:1750]
Crop2 = Image2[100:900,1600:1750]
...
plt.subplot(222)
plt.plot(numpy.mean(Crop1, axis=0))
plt.subplot(224)
plt.plot(numpy.mean(Crop2, axis=0))
plt.show()
